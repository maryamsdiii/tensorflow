...
Original file is located at
    https://colab.research.google.com/drive/1aRacRdh7iOAA10UO_XNNJKfwy5WDHey8
...
list_max_remove=[]
# Down sampling
uniform_sample = set(np.random.randint(low=0, high=1010, size=1800)) #generate some more for the duplicates
uniform_sample = list(uniform_sample)[:808]
